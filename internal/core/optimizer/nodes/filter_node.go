...
func NewFilterNode(child PhysicalPlanNode, predicate semantic.ResolvedExpr) *FilterNode {
	return &FilterNode{
		child:     child,
		predicate: predicate,
	}
...
func (node *FilterNode) Child() PhysicalPlanNode {
	return node.child
}
...
func (node *FilterNode) Children() []PhysicalPlanNode {
